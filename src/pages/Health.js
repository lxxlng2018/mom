            ...
            <div className="content">
                ...
                <List>
                    <div className="doctor-notice">
                        <div className="time">2018-04-22</div>
                        <div className="doctor-notice-content">
                            <div className="doc-thumb">
                                <img src="./icons/1.png" alt=""/>
                            </div>
                            <div className="tips">今日提示：请您关注今天的中老年疾病防治专家提示</div>
                            <div className="share-btn"><Button type="primary" size="small" inline>送爸妈</Button></div>
                        </div>
                    </div>
                </List>
            </div>
